 ...
 */
val PAT_ENV_KEY = "GITHUB_PERSONAL_ACCESS_TOKEN"
...
extra.set("ciniraArtifacts", Action<RepositoryHandler> {
    maven {
        val cinira_artifacts_repo_username: String by extra("cinira-llc")
        name = "ciniraArtifacts"
        url = uri("https://maven.pkg.github.com/cinira-llc/artifacts")
        credentials {
